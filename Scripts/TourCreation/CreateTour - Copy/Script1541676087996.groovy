...
InternalData object = findTestData('InternalData/Object_repo_tour')

/*-----Filling up form using data from Internal Data------*/
int x = 0

WebUI.setText(findTestObject('Common/textbox_name', [('name') : object.internallyGetValue(x, 0)]), data.internallyGetValue(x++, 0))
